**This fork is intended to begin applying asynchronous access to the Alchemy interface. Please note that the target framework for this version is .Net 4.5.
